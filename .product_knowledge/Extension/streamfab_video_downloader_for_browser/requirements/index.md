...
| 文件 | 用途 |
| --- | --- |
| [`plugin_requirement.md`](plugin_requirement.md) | 主需求文档，对外交付给开发 / PM |
...
| 文件 | 用途 |
| --- | --- |
| [`site_research_notes.md`](site_research_notes.md) | 站点技术调研（含 yt-dlp Extractor、DRM 边界、格式选择、反检测机制等） |
