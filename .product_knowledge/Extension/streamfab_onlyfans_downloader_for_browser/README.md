# StreamFab OnlyFans Downloader for Browser

面向 OnlyFans 用户的专用浏览器下载插件，仅支持 `onlyfans.com` 单站点，覆盖 Message videos、DRM video 与普通 Post 视频。
...
| 上线状态 | 已上线 |
| 视频画质 | 最高 1080P（FHD） |
| Banner 文案锚点 | Creator Videos, Downloaded Simply. / 1080p / clean AAC audio |
