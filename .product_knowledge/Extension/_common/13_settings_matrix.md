# 13 Setting 配置项矩阵（Settings Matrix）
...
> 单插件特殊配置项（如 Netflix `Video Codec`、`H264 Profile`）写入插件 `plugin_differences.md`
> 关联：[10_detection_modes.md](10_detection_modes.md)、[10_detection_modes.md](10_detection_modes.md)
...
## 四、插件特殊配置项（写入插件 plugin_differences.md）
