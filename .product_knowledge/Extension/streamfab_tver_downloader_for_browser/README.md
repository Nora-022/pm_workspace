...
| 站点 | `tver.jp` |
| 地区 | 日本（AVOD 免费追剧平台） |
| 内容形态 | 日本电视台联合点播（日剧 / 综艺 / 纪录片 / 动画） |
| 跳转 slug | `tver-downloader` |
...
- DevTools 抓包：[`requirements/devtools_fetch_dump.js`](requirements/devtools_fetch_dump.js)
