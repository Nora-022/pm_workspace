...
## 当前阶段
- 已上线：Video、Amazon、Netflix、Disney Plus、M3U8
- 集成中：OnlyFans、U-NEXT
- 待研发：Hulu、TVer、FANZA、Fandango at Home、MyFans
...
| `streamfab_onlyfans_downloader_for_browser` | 集成中 | `C:\Users\fab\yuki-studio-repo\pm-workspace\.product_knowledge\Extension\streamfab_onlyfans_downloader_for_browser` |
...
| `streamfab_fanza_downloader_for_browser` | 待研发 | `C:\Users\fab\yuki-studio-repo\pm-workspace\.product_knowledge\Extension\streamfab_fanza_downloader_for_browser` |
...
| `streamfab_myfans_downloader_for_browser` | 待研发 | `C:\Users\fab\yuki-studio-repo\pm-workspace\.product_knowledge\Extension\streamfab_myfans_downloader_for_browser` |
